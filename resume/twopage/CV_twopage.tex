...
{\bf RIKEN Center for Advanced Intelligence Project}, Japan \hfill {Expected January 2025}
...
\begin{enumerate}[leftmargin=0.2in]
	...
	\setcounter{enumi}{0}
	\item Long-Fei Li, \textbf{Yu-Jie Zhang}, Peng Zhao, and Zhi-Hua Zhou. Provably Efficient Reinforcement Learning with Multinomial Logit Function Approximation. In {Advances in Neural Information Processing Systems 37} (\textbf{NeurIPS}), 2024.
